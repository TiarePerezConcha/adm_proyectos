...
export const SEED_MONITORED_PROJECTS: MonitoredProject[] = [
  {
    id: 'mon-curriculum-tiare',
    name: 'Portfolio & CV Tiare Pérez',
    clientName: 'Tiare Pérez Concha',
    url: 'https://tiareperezconcha.github.io/curriculumpage/tiare/',
    status: 'online',
    uptimePercentage: 100.0,
    avgResponseTimeMs: 145,
    sslValid: true,
    sslExpiresDays: 180,
    lastHeartbeat: 'Agente LSC v1.0 Activo',
    supabaseKeepAliveEnabled: true,
    lastSupabasePing: 'Conectado a cvfybrtblxzpawnxqsnd',
    recentErrors: [],
  },
  {
    id: 'mon-curriculum-fernando',
    name: 'Curriculum Fernando',
    clientName: 'Fernando',
    url: 'file:///D:/tiare/proyectos/curriculumpage/fernandogratis/index.html',
    status: 'online',
    uptimePercentage: 100.0,
  ...
  {
    id: 'mon-comparativa-materiales',
    name: 'App Comparativa Precios Materiales',
    clientName: 'Sector Construcción Chile',
    url: 'file:///D:/tiare/proyectos/app%20comparativa%20precios%20materiales%20contruccion/preview/index.html',
    status: 'online',
  ...
  {
    id: 'mon-contactos-react',
    name: 'Contactos React App',
    clientName: 'Gestión de Contactos',
    url: 'http://localhost:5173/contactos',
    status: 'online',
  ...
  {
    id: 'mon-conpi-react',
    name: 'Proyecto CONPI Web',
    clientName: 'CONPI Chile',
    url: 'http://localhost:3000/conpi',
    status: 'online',
  ...
  {
    id: 'mon-karate-admin',
    name: 'Federación Karate Admin & Alumno',
    clientName: 'Federación de Karate',
    url: 'file:///D:/tiare/proyectos/proyecto%20karate/prototipo/fedkarate_admin.html',
    status: 'online',
    uptimePercentage: 100.0,
