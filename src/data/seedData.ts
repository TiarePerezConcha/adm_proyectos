...
export const SEED_MONITORED_PROJECTS: MonitoredProject[] = [
  {
    ...
    sslValid: true,
    sslExpiresDays: 180,
    lastHeartbeat: 'Agente LSC v2.0 Activo (En vivo)',
  ...
  {
    id: 'comparativa-materiales',
    name: 'App Comparativa Precios Materiales',
    clientName: 'Sector Construcción Chile',
    url: 'https://tiareperezconcha.github.io/comparativa-materiales/',
    status: 'online',
    uptimePercentage: 100.0,
  ...
  },
  {
    ...
    url: 'https://tiareperezconcha.github.io/contactos-react/',
    status: 'online',
    uptimePercentage: 100.0,
  ...
  },
  {
    ...
    url: 'https://tiareperezconcha.github.io/conpi/',
    status: 'online',
    uptimePercentage: 100.0,
